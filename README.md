...
```bash
wget https://github.com/rozsival/panther-minor-controller/releases/download/v1.0.7/setup-device.sh -O setup-device.sh
...
```bash
wget https://github.com/rozsival/panther-minor-controller/releases/download/v1.0.7/install-app.sh -O install-app.sh
...
```bash
wget https://github.com/rozsival/panther-minor-controller/releases/download/v1.0.7/update-app.sh -O update-app.sh
